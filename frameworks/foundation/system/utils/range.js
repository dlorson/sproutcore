...
SC.mixin( /** @scope SC */ {
  ...
  valueInRange: function valueInRange(value, range) {
    return (value >= 0) && (value >= range.start) && (value < (range.start + range.length));
  },

  /** Returns first value of the range. */
  minRange: function minRange(range) { return range.start; },

  /** Returns the first value outside of the range. */
  maxRange: function maxRange(range) { return (range.length < 0) ? -1 : (range.start + range.length); },

  /** Returns the union of two ranges.  If one range is null, the other
   range will be returned.  */
  unionRanges: function unionRanges(r1, r2) {
  ...
  intersectRanges: function intersectRanges(r1, r2) {
  ...
  subtractRanges: function subtractRanges(r1, r2) {
    if ((r1 == null) || (r2 == null)) return SC.RANGE_NOT_FOUND ;
    if ((r1.length < 0) || (r2.length < 0)) return SC.RANGE_NOT_FOUND;
  ...
  cloneRange: function cloneRange(r) {
