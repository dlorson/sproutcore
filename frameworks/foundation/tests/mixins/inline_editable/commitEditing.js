...
test("commitEditing should ask shouldCommit and then call commitEditing", function() {
  ...
  ok(view.commitEditing(), "commitEditing successful");
...
test("commitEditing should fail if shouldCommit returns NO", function() {
  ...
  ok(!view.commitEditing(), "commitEditing failed");
...
test("commitEditing should cleanup properly on success", function() {
  ...
  ok(view.commitEditing(), "committed editing");
...
test("delegate methods are not called when commitEditing fails", function() {
  ...
  SC.run(function() {
    ok(!view.commitEditing(), "commit failed");
  }, undefined, YES);
